...
- [ ] **SCOR-01**: Dimension score = sum of answers in that dimension / number of questions in that dimension, range 1.0–5.0
- [ ] **SCOR-02**: All questions are equally weighted — no question or category weighting
- [ ] **SCOR-03**: GoRules ZEN Engine and MoSCoW scoring are fully removed, not dual-maintained
- [ ] **SCOR-04**: Report/scores are only computed and shown once the full questionnaire is 100% answered (no partial/live scoring)
